...
DROP POLICY IF EXISTS "Authenticated admins can manage blog posts" ON blog_posts;
...
DROP POLICY IF EXISTS "Authenticated admins can manage pages" ON pages;
...
DROP POLICY IF EXISTS "Authenticated admins can manage media" ON media;
...
DROP POLICY IF EXISTS "Authenticated admins can manage settings" ON settings;
...
DROP POLICY IF EXISTS "Admin users can manage themselves" ON admin_users;
